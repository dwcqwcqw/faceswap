        ...
        <div className="bg-gray-50 rounded-lg p-3 text-sm">
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <span className="text-gray-600 ml-1">{task.id}</span>
            </div>
            <div>
            ...
            <div>
              ...
              <span className="text-gray-600 ml-1">{new Date(task.created_at).toLocaleString('zh-CN')}</span>
            </div>
            <div>
              <span className="font-medium text-gray-700">更新时间:</span>
              <span className="text-gray-600 ml-1">{new Date(task.updated_at).toLocaleString('zh-CN')}</span>
            </div>
            {task.progress > 0 && (
          ...
          <div className="bg-gray-50 rounded-lg p-3 text-sm">
            {task.files.source && (
              <div className="mb-1">
                ...
                <span className="text-gray-600 ml-1">{task.files.source}</span>
              </div>
            )}
            {task.files.target && (
              <div className="mb-1">
                <span className="font-medium text-gray-700">目标文件:</span>
                <span className="text-gray-600 ml-1">{task.files.target}</span>
              </div>
            )}
          </div>
        </div>
